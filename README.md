...
A C++ library for creating Monero applications using native bindings to [monero v0.17.3.0 'Oxygen Orion'](https://github.com/monero-project/monero/tree/v0.17.3.0).

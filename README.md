...
A TypeScript library for creating Monero applications using RPC and WebAssembly bindings to [monero v0.18.4.4 'Fluorine Fermi'](https://github.com/monero-project/monero/tree/v0.18.4.4).

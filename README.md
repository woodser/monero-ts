...
<p align="center">
	...
	<i>Build Node.js or browser applications using RPC or WebAssembly bindings to monero-project/<a href="https://github.com/monero-project/monero">monero</a>.  Wallet implementations are interchangeable by conforming to a common interface, <a href="https://moneroecosystem.org/monero-javascript/MoneroWallet.html">MoneroWallet.js</a>.</i>
</p>

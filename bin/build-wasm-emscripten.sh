...
cd ../ &&
mkdir -p dist &&
mv ./build/monero_wallet_keys_wasm.js ./dist/ &&
mv ./build/monero_wallet_keys_wasm.wasm ./dist/ &&
mv ./build/monero_wallet_core_wasm.js ./dist/ &&
mv ./build/monero_wallet_core_wasm.wasm ./dist/

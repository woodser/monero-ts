...
class LibraryUtils {
  ...
  static WORKER_DIST_PATH_DEFAULT = _GenUtils.default.isBrowser() ? "/monero.worker.js" : function () {
    ...
    if (!_fs.default.existsSync(_path.default.join(curPath, "MoneroWebWorker.js"))) curPath = _path.default.join(curPath, "../../../../dist/src/main/ts/common");

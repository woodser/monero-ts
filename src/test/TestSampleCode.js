  ...
  runTests() {
    describe("Test Sample Code", function() {
      ...
      it("Can be demonstrated with sample code", async function() {
        ...
        // connect to a daemon
        let daemon = new MoneroDaemonRpc(TestUtils.DAEMON_RPC_CONFIG);
        ...
        let walletCore = await MoneroWalletCore.createWalletFromMnemonic("./test_wallets/" + GenUtils.uuidv4(), "supersecretpassword123", TestUtils.NETWORK_TYPE, TestUtils.MNEMONIC, TestUtils.getDaemonRpcConnection(), TestUtils.FIRST_RECEIVE_HEIGHT, "", TestUtils.PROXY_TO_WORKER, TestUtils.FS);

  ...
  runTests() {
    describe("Test Sample Code", function() {
      ...
      it("Can be demonstrated with sample code", async function() {
        ...
        let walletCore = await MoneroWalletCore.createWalletFromMnemonic("./test_wallets/" + GenUtils.uuidv4(), "supersecretpassword123", MoneroNetworkType.STAGENET, TestUtils.MNEMONIC, new MoneroRpcConnection("http://localhost:38081"), TestUtils.FIRST_RECEIVE_HEIGHT);

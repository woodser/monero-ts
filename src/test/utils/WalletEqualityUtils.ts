...
export default class WalletEqualityUtils {
  ...
  protected static async testAccountsEqualOnChain(accounts1, accounts2) {
  ...
  protected static async testAccountEqualOnChain(account1, account2) {
  ...
  protected static async testSubaddressesEqualOnChainAux(subaddresses1, subaddresses2) {
  ...
  protected static async transferCachedInfo(src, tgt) {
    ...
    if (src.getIncomingTransfers() !== undefined) {
      ...
      // sort transfers
      tgt.getIncomingTransfers().sort(MoneroWalletRpc.compareIncomingTransfers);
    }
  ...
  protected static async testTransfersEqualOnChain(transfers1, transfers2) {
    ...
    for (let txHash of Object.keys(txsTransfers1)) {
      ...
      for (let i = 0; i < txTransfers1.length; i++) {
        ...
        if (transfer1 instanceof MoneroOutgoingTransfer && transfer2 instanceof MoneroOutgoingTransfer) {
          let ot1 = transfer1;
          let ot2 = transfer2;
  ...
  protected static async testOutputWalletsEqualOnChain(outputs1, outputs2) {

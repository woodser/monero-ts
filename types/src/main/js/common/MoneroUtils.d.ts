...
declare class MoneroUtils {
     ...
     */
    static setProxyToWorker(proxyToWorker: boolean): void;
    /**
     ...
     */
    static validateMnemonic(mnemonic: string): Promise<void>;
    /**
     ...
     */
    static isValidPrivateViewKey(privateViewKey: string): Promise<bool>;
    /**
     ...
     */
    static isValidPublicViewKey(publicViewKey: string): Promise<bool>;
    /**
     ...
     */
    static isValidPrivateSpendKey(privateSpendKey: string): Promise<bool>;
    /**
     ...
     */
    static getIntegratedAddress(networkType: MoneroNetworkType, standardAddress: string, paymentId: string, ...args: any[]): Promise<MoneroIntegratedAddress>;
    /**
     ...
     */
    static isValidAddress(address: string, networkType: MoneroNetworkType): Promise<boolean>;
    /**
     ...
     * @param {MoneroNetworkType} networkType - network type of the address to validate
     */
    static validateAddress(address: string, networkType: MoneroNetworkType, ...args: any[]): Promise<any>;
    /**
     ...
     */
    static isValidPaymentId(paymentId: string): Promise<bool>;
    /**
     ...
     */
    static validatePaymentId(paymentId: string): Promise<void>;
    /**
     ...
     */
    static jsonToBinary(json: object, ...args: any[]): Promise<Uint8Array>;
    /**
     ...
     */
    static binaryToJson(uint8arr: Uint8Array, ...args: any[]): Promise<object>;
    /**
     ...
     */
    static binaryBlocksToJson(uint8arr: Uint8Array, ...args: any[]): Promise<object>;
    /**
...
declare namespace MoneroUtils {
    let PROXY_TO_WORKER: boolean;
    let NUM_MNEMONIC_WORDS: number;
    let RING_SIZE: number;
    let MAX_REQUESTS_PER_SECOND: number;
    let AU_PER_XMR: number;
}
